...
def line_style_diff():
    ...
    line_styles = {"sqlite": "dotted", "mongodb": "dashdot", "parquetdb": "solid"}
    ...
    for benchmark_dir in benchmark_dirs:
        ...
        ax1.plot(
            df["n_rows"],
            df["create_times"],
            label=f"{basename} create",
            color=colors["create_times"],
            linestyle=line_styles[basename],
        )
    ...
    for benchmark_dir in benchmark_dirs:
        ...
        ax2.plot(
            df["n_rows"],
            df["read_times"],
            label=f"{basename} read",
            color=colors["read_times"],
            linestyle=line_styles[basename],
        )
...
def color_diff_plot():
    ...
    colors = {"sqlite": "blue", "mongodb": "green", "parquetdb": "red"}
...
def color_diff_log_two_axes_plot(savefig=None):
    ...
    # Define a color map for different databases
    colors = {"sqlite": "#3B9AB2", "mongodb": "#EBCC2A", "parquetdb": "#F21A00"}
...
def color_diff_log_inset_plot(savefig=None):
    ...
    for benchmark_dir in benchmark_dirs:
        ...
        ax1.plot(
            ...
            color=colors[basename],
            linestyle=line_styles["create_times"],
            marker=marker_styles[basename],
            fillstyle=marker_fill_styles[basename]["create_times"],
        )
    ...
    for benchmark_dir in benchmark_dirs:
        ...
        ax2.plot(
            ...
            linestyle=line_styles["read_times"],
            marker=marker_styles[basename],
            fillstyle=marker_fill_styles[basename]["read_times"],
        )
    ...
    ax_inset2.spines["right"].set_linewidth(
        2.5
