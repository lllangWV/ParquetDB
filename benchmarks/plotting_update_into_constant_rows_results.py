...
if __name__ == '__main__':
    ...
    color_diff_log_inset_plot(savefig=os.path.join(benchmark_dir, 'benchmark_update_into_constant_rows_times.pdf'))
    color_diff_log_inset_plot(savefig=os.path.join(benchmark_dir, 'benchmark_update_into_constant_rows_times.png'))
