...
benchmark_files_dict = {
    "sqlite": [
        "sqlite_needle_in_haystack_with_index_benchmark.csv",
        "sqlite_needle_in_haystack_without_index_benchmark.csv",
    ],
    "mongodb": [
        "mongodb_needle_in_haystack_with_index_benchmark.csv",
        "mongodb_needle_in_haystack_without_index_benchmark.csv",
    ],
...
marker_fill_styles = {
    "sqlite": {"with_index": "full", "without_index": "none"},
    "mongodb": {"with_index": "full", "without_index": "none"},
    "parquetdb": "full",
}
...
def color_diff_log_inset_plot(savefig=None):
    ...
    ax_inset.set_ylabel(
        "Read Time (log)", fontsize=8, labelpad=-2
    )  # Added labelpad to move label right
